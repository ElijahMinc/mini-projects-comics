...
},{}],"mdTS":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.IMG_NOT__AVIABLE = exports.IMG_STANDART__XLARGE = exports.URL_CHARACTERS = exports.URL_COMICS = exports.API_URL = exports.API_KEY = void 0;
...
var IMG_STANDART__XLARGE = 'standard_xlarge';
exports.IMG_STANDART__XLARGE = IMG_STANDART__XLARGE;
var IMG_NOT__AVIABLE = 'image_not_available';
exports.IMG_NOT__AVIABLE = IMG_NOT__AVIABLE;
...
},{"./lib/axios":"nUiQ"}],"gExD":[function(require,module,exports) {
"use strict";
...
var ROOT_INDEX = document.querySelector('#root');
exports.ROOT_INDEX = ROOT_INDEX;
var ROOT_MODAL = document.querySelector('#modal');
exports.ROOT_MODAL = ROOT_MODAL;
},{}],"dXl3":[function(require,module,exports) {
module.exports = "cancel-white.3c154c50.svg";
},{}],"cwV6":[function(require,module,exports) {
module.exports = "cancel-black.f02a42c4.svg";
},{}],"LYV6":[function(require,module,exports) {

},{}],"ZzOq":[function(require,module,exports) {
"use strict";
...
var _cancelBlack = _interopRequireDefault(require("./img/cancel-black.svg"));
...
exports.default = _default;
},{"../../constants/root":"kqQd","./img/cancel-black.svg":"cwV6","./Notification.css":"LYV6"}],"cv2C":[function(require,module,exports) {
"use strict";
...
var _cancelWhite = _interopRequireDefault(require("./img/cancel-white.svg"));
  ...
  _createClass(Characters, [{
    ...
    value: function renderContent(data) {
      ...
      data.forEach(function (_ref) {
        ...
        var imgSrc = path + '/' + _api.IMG_STANDART__XLARGE + '.' + extension;
        htmlContent += "\n         <li class=\"characters__item\">\n            <img class=\"characters__img\" src=\"".concat(imgSrc, "\">\n            <span class=\"characters__name\">").concat(name, "</span>\n         </li>\n         ");
      });
      var htmlWrapper = "\n      <div class=\"modal-wrapper\">\n         <ul class=\"characters__container\">\n            ".concat(htmlContent, ";\n         </ul>\n         <button class=\"btn-close characters__close\" \n         onclick=\"modal.innerHTML = ''\" \n         style=\"background-image: url(").concat(_cancelWhite.default, ")\">\n\n         </button>\n      </div >\n         "); // name
      // thumbnail => extension, path

      _root.ROOT_MODAL.innerHTML = htmlWrapper;
      console.log(_cancelWhite.default);
    }
  }, {
    key: "renderNotification",
    value: function renderNotification() {
      _Notification.default.render();
    }
  }, {
    key: "render",
    value: function () {
      var _render = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(uriEl) {
        var data;
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return _getDataApi.default.getData(uriEl);
...
exports.default = _default;
},{"../../utils/getDataApi":"gExD","../../constants/api":"mdTS","../../constants/root":"kqQd","./img/cancel-white.svg":"dXl3","../Notification/Notification":"ZzOq","./Characters.css":"LYV6"}],"Hht8":[function(require,module,exports) {
"use strict";
...
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
},{"./Characters":"cv2C"}],"dBnP":[function(require,module,exports) {
"use strict";
...
exports.default = _default;
},{"../../constants/root":"kqQd","./Error.css":"LYV6"}],"HlgU":[function(require,module,exports) {
"use strict";
...
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
},{"./Error":"dBnP"}],"UV1h":[function(require,module,exports) {
"use strict";
  ...
  _createClass(Comics, [{
    ...
    value: function renderComics(data) {
      ...
      data.forEach(function (_ref) {
        ...
        if (path.lastIndexOf(_api.IMG_NOT__AVIABLE) === -1) {
          // возвращаем только те данные, у которых есть картинки
          var uri = _api.API_URL + _api.URL_COMICS + '/' + id + '/' + _api.URL_CHARACTERS; // ссылка на новый запрос
        ...
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return _getDataApi.default.getData(_api.API_URL + _api.URL_COMICS);
    ...
    value: function eventListener() {
      document.querySelectorAll('.comics__item').forEach(function (el) {
        var uriEl = el.dataset.uri;
        el.addEventListener('click', function () {
          _Characters.default.render(uriEl);
        });
      });
    }
  }]);
...
exports.default = _default;
},{"../../constants/api":"mdTS","../../utils/getDataApi":"gExD","./../../constants/root":"kqQd","../Characters":"Hht8","../Error":"HlgU","./Comics.css":"LYV6"}],"staH":[function(require,module,exports) {
"use strict";
...
exports.default = _default;
},{"../Comics":"staH","./App.css":"LYV6"}],"ToZP":[function(require,module,exports) {
"use strict";
